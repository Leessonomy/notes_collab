...
import { lucideMoon, lucideSun, lucideMenu, lucideX } from '@ng-icons/lucide';
...
@Component({
  ...
  providers: [provideIcons({ lucideMoon, lucideSun, lucideMenu, lucideX })],
  template: `
    <header
